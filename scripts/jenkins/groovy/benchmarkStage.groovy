  ...
  dir (ML_BENCHMARK_ROOT) {
    retry(3) {
      timeout(time: 1, unit: 'MINUTES') {
        checkout changelog: false, poll: false, scm: [$class: 'GitSCM', branches: [[name: 'mr/ita/336-gpu-xgb-benchmark']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: H2O_OPS_CREDS_ID, url: 'https://github.com/h2oai/ml-benchmark']]]
      }
    }
  }
